...
@Entity
@Table(name = "ws_instance_calibration_preparation_step")
public class CalibratorPreparationStepInstance extends WorksheetStep {
    ...
    public String toString() {
        ...
        buff.append("CalibratorPreparationStepInstance: dbid=");
        buff.append(dbid);
